...
import { CoachingTable } from '@/components/coaching-table';
...
export default async function CoachingPage() {
  ...
  if (!isConnected) {
    return (
      <div className="flex flex-col flex-1 overflow-y-auto">
        <Topbar title="Riwayat Coaching" isDatabaseConnected={false} connectionName={config?.name} />
  ...
  return (
    <div className="flex flex-col flex-1 overflow-y-auto">
      <Topbar 
        title="Riwayat Coaching Petugas" 
        subtitle="Daftar rekapitulasi sesi pembinaan dan materi coaching berkala" 
