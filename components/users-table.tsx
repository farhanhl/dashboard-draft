          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 text-[10px] uppercase font-bold text-slate-400 tracking-wider">
                ...
                >
                  Nama Pengguna {sortField === 'name' && (sortAsc ? '▲' : '▼')}
                </th>
                <th 
                  onClick={() => handleSort('email')}
                  className="px-4 py-4 cursor-pointer select-none hover:bg-slate-100/50 transition-colors"
                >
                  Email {sortField === 'email' && (sortAsc ? '▲' : '▼')}
                </th>
                <th 
                  onClick={() => handleSort('role')}
                  className="px-4 py-4 text-center cursor-pointer select-none hover:bg-slate-100/50 transition-colors"
                >
                ...
                <th 
                  ...
                  className="px-4 py-4 cursor-pointer select-none hover:bg-slate-100/50 transition-colors"
                >
                  Tgl Terdaftar {sortField === 'created_at' && (sortAsc ? '▲' : '▼')}
                </th>
